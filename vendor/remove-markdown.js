...
(function(root) {
  function removeMarkdown(md, options) {
    ...
    options.replaceLinksWithURL = Object.prototype.hasOwnProperty.call(options, 'replaceLinksWithURL') ? options.replaceLinksWithURL : false;
    options.htmlTagsToSkip = Object.prototype.hasOwnProperty.call(options, 'htmlTagsToSkip') ? options.htmlTagsToSkip : [];
  ...
  root.removeMarkdown = removeMarkdown;
